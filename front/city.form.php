...
$object = new PluginGestionSiteCity();
...
if (isset($_POST['add'])) {
   ...
   Html::redirect("{$CFG_GLPI['root_doc']}/plugins/front/city.form.php?id=$newid");
   ...
   //Redirect to objects list
   Html::redirect("{$CFG_GLPI['root_doc']}/plugins/front/city.php");
} else {
